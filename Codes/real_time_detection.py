...
model=load_model(r'D:\Study\doancn\FireNet\Codes\TrainedModels\Fire.h5')

cap = cv2.VideoCapture(r'D:\Study\doancn\FireNet\Our_Complete_Dataset_Video_and_extra_NoFire_Frames\fire\FireVid20.mp4')
time.sleep(2)
